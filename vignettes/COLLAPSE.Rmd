...
![Collapse branches example 1: Simple and text branches collapsed](images/COLLAPSE_1.png)
...
![Collapse branches example 2: Node-based branch collapsing](images/COLLAPSE_2.png)
