...
![Prune example 1: Most used and complex templates](images/PRUNE_1.png)
...
![Prune example 2: DATASET_ branches selection](images/PRUNE_2.png)
...
![Prune example 3: Templates with more than 30 parameters](images/PRUNE_3.png)
