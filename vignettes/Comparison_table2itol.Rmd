...
![table2itol workflow diagram](images/table2itol.svg)
...
![itol.toolkit workflow diagram](images/0.svg)
...
![Labels example with genus names](images/1.svg)
...
![Tree colors by phylum](images/2.svg)
...
![Color strip by class](images/3.svg)
...
![Multibar chart example](images/4.svg)
...
![Pie chart example](images/5.svg)
...
write_unit(unit_6)
```
![Final combined visualization](images/6.svg)
