...
In the case of data without the third column, the program will add colors automatically. Without setting the "color" parameter, itol.tookit will use the default palette (refer to [Color_Palette](https://tongzhou2017.github.io/itol.toolkit/articles/Color_Palette.html) for detail information). Moreover, several other styles of text can be specified by users, which are described as follows:
