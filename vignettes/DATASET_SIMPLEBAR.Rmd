...
```
### Style modification
By adjusting `unit@specific_themes$basic_plot$size_max`, users can customize the size of the plot. Here, we set a standard size for E029 and E030.
```{r set size}
