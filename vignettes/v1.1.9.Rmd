...
```{r, fig.alt="Color sorting algorithm demonstration with Wes Anderson color palette"}
set.seed(123)
...
```{r, fig.alt="Tree visualization based on template string vector"}
...
```{r, fig.alt="Tree visualization based on data frame row/column names"}
